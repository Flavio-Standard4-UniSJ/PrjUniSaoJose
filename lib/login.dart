...
//https://facebook.meedu.app/#/login
...
class LoginScreenState extends State<LoginScreen> {
  ...
  Future<Null> handleSignIn() async {
    ...
    if (googleUser != null) {
      ...
      if (firebaseUser != null) {  //achar os usuários
        // Check is already sign up
        final QuerySnapshot result =
        await FirebaseFirestore.instance.collection('users').where('id', isEqualTo: firebaseUser.uid).get();
        final List<DocumentSnapshot> documents = result.docs;//select no banco de dados (firebase storage) e  
        //procura o user igual ao firebase.user
